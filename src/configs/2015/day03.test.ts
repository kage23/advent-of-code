...
describe('2015 Day 03', () => {
  ...
  describe('Part 2', () => {
    describe('deliverPresentsWithRoboSanta', () => {
      it('should count how many houses get at least one present', () => {
        expect(
          deliverPresentsWithRoboSanta(inputs.get('DEMO_4')!).answer2
        ).toEqual(3)
        expect(
          deliverPresentsWithRoboSanta(inputs.get('DEMO_2')!).answer2
        ).toEqual(3)
        expect(
          deliverPresentsWithRoboSanta(inputs.get('DEMO_3')!).answer2
        ).toEqual(11)
      })
    })
  })
