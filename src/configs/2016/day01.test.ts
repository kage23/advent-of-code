  ...
  describe('Part 1', () => {
    describe('findEndOfPath', () => {
      it('should determine how far away the Easter Bunny HQ is', () => {
        expect(findEndOfPath(inputs.get('DEMO_1_1')!).answer1).toEqual(5)
        expect(findEndOfPath(inputs.get('DEMO_1_2')!).answer1).toEqual(2)
        expect(findEndOfPath(inputs.get('DEMO_1_3')!).answer1).toEqual(12)
      })
    })
  })
  describe('Part 2', () => {
