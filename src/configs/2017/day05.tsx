...
const step = (instructions: number[], currentInstructionIndex: number, v2?: boolean) => {
...
export const stepToEnd1 = (inputKey: string) => {
  let steps = 0
  let currentInstructionIndex = 0
  const instructions = parseInput(inputs.get(inputKey)!)

  while (currentInstructionIndex < instructions.length && currentInstructionIndex >= 0) {
...
export const stepToEnd2 = (inputKey: string) => {
  let steps = 0
  let currentInstructionIndex = 0
  const instructions = parseInput(inputs.get(inputKey)!)
