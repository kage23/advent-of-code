import inputs from '../../inputs/2021/day24'
import { DayConfig } from '../../routes/Day'

/**
 * In doing my rebuild, I'm not sure how I solved this one;
 * manually maybe? I didn't really look into it in the rebuild.
 */

export const getHighestModel = (input: string) => {
...
export const getLowestModel = (input: string) => {
  const instructions = input.split('\n')
...
const day24: Omit<DayConfig, 'year'> = {
  answer1Text: 'The highest valid model number is answer.',
  answer2Text: 'The lowest valid model number is answer.',
  buttons: [
    {
      label: 'Get the Highest Model',
      onClick: getHighestModel,
    },
    {
      label: 'Get the Lowest Model',
      onClick: getLowestModel,
    },
  ],
  id: 24,
  inputs,
